...
icon_arr=['champune.png','Snickers.jpg','albeni.jpg','chokaz.png','fusetea.jpg',
      'dadasok.png','IMG_2058-removebg-preview.png','lays.png','vaphli.png','vaphli2.png','bag.png','яшкиноКруасан.jpg']
...
id=['0xe2 0x80 0x68 0x94 0x0 0x0 0x40 0x6 0xe5 0xf6 0x21 0x3c ',
    '0xe2 0x80 0x68 0x94 0x0 0x0 0x50 0x6 0xe5 0xf6 0x21 0x54 ',
    '0xe2 0x80 0x68 0x94 0x0 0x0 0x40 0x6 0xe5 0xf6 0x21 0x4b ',#3
    '0xe2 0x80 0x68 0x94 0x0 0x0 0x40 0x6 0xe5 0xf6 0x22 0x39 ',
    '0xe2 0x80 0x68 0x94 0x0 0x0 0x50 0x6 0xe5 0xf6 0x21 0x51 ',
    ...
    '0xe2 0x80 0x68 0x94 0x0 0x0 0x40 0x6 0xe5 0xf6 0x21 0x47 ',#12
    ]

name=['Albeni XXL', 'Snickers', 'Albeni XXL', 'Шоколад Казахстан', 'Fuse Tea Mango-Ananas', 'Сок DaDa 0.5л',
      'Сливки 250мл','Lays паприка 81г','Яшкино вафельный сендвич','Яшкино Мягкие вафли','test','Книга "самый богатый человек в Вавилоне"']
    ...
    if iTagNumber.value > 0:
        ...
        for iIndex in range(0,  iTagNumber.value):
            ...
            for k in a:
                ...
                icon_small = pygame.transform.scale(icon, (100, 60))
